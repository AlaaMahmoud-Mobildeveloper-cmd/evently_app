                ...
                Container(
                  ...
                  child: ListView.separated(
                      ...
                      itemBuilder:(context, index) =>InkWell(
                        onTap: (){
                          provider.changeSelectCategory(index);

                        },
                        child: Chip(
                            backgroundColor: provider.selectedCategory == index ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.surface,
