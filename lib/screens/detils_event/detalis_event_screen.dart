...
import 'package:evently_app/Provider/hom_page_provider.dart';
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            leading: IconButton(
                ...
                icon: Image.asset(themeProvider.themeMode == ThemeMode.light? ImageApp.back:ImageApp.darkBack,
            ...
            actions: [
              ...
              IconButton(
                  ...
                  icon: Image.asset(ImageApp.edit,)
              ),
              IconButton(
            ...
            child: Column(
              ...
              children: [
                ClipRRect(
                  ...
                  child:themeProvider.themeMode == ThemeMode.light? Image.asset("assets/images/${model.categories}.png",
                    width: double.infinity,
                    height: 200,
                    fit: BoxFit.cover,
                  ): Image.asset("assets/images/${model.categories}dark.png",
                    width: double.infinity,
                    height: 200,
                    fit: BoxFit.cover,
                  ),
                  ...
                  child: Row(
                      ...
                      children:[
                        Container(
                          ...
                          child: ImageIcon(AssetImage(ImageApp.addCalender),
                            color: Theme.of(context).colorScheme.primary,
                            size: 30,
                          ),
                ...
                Column(
                  ...
                  spacing: 10,
                  children: [
                    Text(StringApp.descriptionFormField,
